...
function lint(command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield lint_1.performLintCheck(pathToFiles, useTestConfig);
...
function lintFix(command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const pathToFiles = getPathToFiles(command);
            const useTestConfig = command.test;
            yield lint_1.performLintFix(pathToFiles, useTestConfig);
...
function prettier(command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const pathToFiles = getPathToFiles(command);
            yield lint_1.makeFilesPrettier(pathToFiles);
