...
function parseWebViewType(webViewString) {
    switch (webViewString ? webViewString.toLowerCase() : undefined) {
        ...
        case undefined:
            return undefined;
        default:
            throw new office_addin_usage_data_1.ExpectedError(`Please select a valid web view type instead of '${webViewString}'.`);
    }
}
exports.parseWebViewType = parseWebViewType;
function register(manifestPath, command /* eslint-disable-line no-unused-vars */) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function registered(command /* eslint-disable-line no-unused-vars */) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function sideload(manifestPath, type, command) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const appType = appType_1.parseAppType(type || process.env.npm_package_config_app_platform_to_debug);
            yield sideload_1.sideloadAddIn(manifestPath, app, canPrompt, appType, document);
...
function toDebuggingMethod(text) {
    switch (text) {
        ...
        case undefined:
            ...
            return devSettings.DebuggingMethod.Direct;
        default:
            throw new office_addin_usage_data_1.ExpectedError(`Please provide a valid debug method instead of '${text}'.`);
    }
}
function unregister(manifestPath, command /* eslint-disable-line no-unused-vars */) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (manifestPath === "all") {
