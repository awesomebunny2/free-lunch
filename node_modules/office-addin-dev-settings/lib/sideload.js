        ...
        try {
            ...
            if (app) {
                if (appsInManifest.indexOf(app) < 0) {
                    throw new office_addin_usage_data_1.ExpectedError(`The Office Add-in manifest does not support ${office_addin_manifest_1.getOfficeAppName(app)}.`);
                }
            }
            else {
            ...
            switch (appType) {
                case appType_1.AppType.Desktop:
                    if (!isSideloadingSupportedForDesktopHost(app)) {
                        throw new office_addin_usage_data_1.ExpectedError(`Sideload to the ${office_addin_manifest_1.getOfficeAppName(app)} app is not supported.`);
                    }
                ...
                case appType_1.AppType.Web: {
                    ...
                    if (!isSideloadingSupportedForWebHost(app)) {
                        throw new office_addin_usage_data_1.ExpectedError(`Sideload to the ${office_addin_manifest_1.getOfficeAppName(app)} web app is not supported.`);
                    }
            ...
            if (sideloadFile) {
                if (app === office_addin_manifest_1.OfficeApp.Outlook) {
                    ...
                    process_1.startDetachedProcess(sideloadFile);
                }
                else {
