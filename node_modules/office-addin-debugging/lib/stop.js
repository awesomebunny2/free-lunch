    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (isWindowsPlatform) {
                yield office_addin_dev_settings_1.clearDevSettings(manifestInfo.id);
            }
            // unregister
            try {
                yield office_addin_dev_settings_1.unregisterAddIn(manifestPath);
            }
            catch (err) {
            ...
            if (processId) {
                process_1.stopProcess(processId);
