...
function parsePlatform(text) {
    ...
    switch (text) {
        ...
        default:
            throw new office_addin_usage_data_1.ExpectedError(`The current platform is not supported: ${process.platform}`);
    }
}
        ...
        try {
            ...
            if (enableSideload) {
                try {
                    ...
                    yield office_addin_dev_settings_1.sideloadAddIn(manifestPath, app, true, appType, document);
                }
                catch (err) {
