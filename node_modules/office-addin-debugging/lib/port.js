        ...
        childProcess.exec(command, (error, stdout) => {
            if (error) {
                ...
                if (isWin32) {
                    ...
                    lines.forEach((line) => {
                        const [proto /* eslint-disable-line no-unused-vars */, recv /* eslint-disable-line no-unused-vars */, send /* eslint-disable-line no-unused-vars */, local_address, remote_address /* eslint-disable-line no-unused-vars */, state /* eslint-disable-line no-unused-vars */, program,] = line.split(" ").filter((text) => text);
                    ...
                    lines.forEach((line) => {
                        const [process /* eslint-disable-line no-unused-vars */, processId, user /* eslint-disable-line no-unused-vars */, fd /* eslint-disable-line no-unused-vars */, type /* eslint-disable-line no-unused-vars */, device /* eslint-disable-line no-unused-vars */, size /* eslint-disable-line no-unused-vars */, node /* eslint-disable-line no-unused-vars */, name /* eslint-disable-line no-unused-vars */,] = line.split(" ").filter((text) => text);
