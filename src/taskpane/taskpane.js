...
async function onTableChanged(eventArgs: Excel.TableChangedEventArgs) { //This function will be using event arguments to collect data from the workbook
  ...
  Excel.run(async (context) => {
    //var tableColumn = context.workbook.tables.getItem("ProjectTypeTable").columns.getItem(0);
    ...
    return context.sync().then(function () { // WHAT IS LOOPING
      ...
      console.log("brandNewBuild: " + brandNewBuild);
      console.log("newBuildOtherNatives: " + newBuildOtherNatives);
      console.log("newBuildFromTemplate: " + newBuildFromTemplate);
      console.log("changesToExistingNatives: " + changesToExistingNatives);
      console.log("specCheck: " + specCheck);
      console.log("weTransferUpload: " + weTransferUpload);
      console.log("specialRequest: " + specialRequest);
      console.log("other: " + otherProjectType);

      console.log("other: " + otherProduct);
